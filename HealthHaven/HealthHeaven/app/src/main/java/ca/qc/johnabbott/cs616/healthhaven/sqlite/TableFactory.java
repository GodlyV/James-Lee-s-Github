 ...
 */
public class TableFactory<T extends Identifiable<Long,T>> {
     ...
     * @return
     */
    public static <T extends Identifiable<Long,T>> TableFactory<T> makeFactory(SQLiteOpenHelper handler, Class<T> model) {
