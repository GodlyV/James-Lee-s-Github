...
{
    public partial class AdventureWorksLT2017gr15Context : DbContext
    {
        public AdventureWorksLT2017gr15Context()
        {
        }

        public AdventureWorksLT2017gr15Context(DbContextOptions<AdventureWorksLT2017gr15Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=10.39.167.244\\SQLEXPRESS_316;Database=AdventureWorksLT2017gr15;User ID=Student516gr15;Password=2MV$WX&+yt&K&y#X");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SalesOrderHeader>(entity =>
            {
                ...
                entity.Property(e => e.OnlineOrderFlag).HasComment("0 = Order placed by sales person. 1 = Order placed online by customer.");
        ...
        public DbSet<BikeStore.Models.Account> Account { get; set; }

        public DbSet<BikeStore.Models.Login> Login { get; set; }
    }
}
