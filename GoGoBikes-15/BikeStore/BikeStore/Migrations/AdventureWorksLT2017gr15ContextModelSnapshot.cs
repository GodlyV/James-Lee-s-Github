...
{
    [DbContext(typeof(AdventureWorksLT2017gr15Context))]
    partial class AdventureWorksLT2017gr15ContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BikeStore.Models.Address", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.BuildVersion", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.CustomerAddress", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnName("CustomerID")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BikeStore.Models.ErrorLog", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.ProductCategory", b =>
                {
                    b.Property<int>("ProductCategoryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductCategoryID")
            ...
            modelBuilder.Entity("BikeStore.Models.ProductDescription", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.ProductModel", b =>
                {
                    b.Property<int>("ProductModelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ProductModelID")
            ...
            modelBuilder.Entity("BikeStore.Models.ProductModelProductDescription", b =>
                {
                    b.Property<int>("ProductModelId")
                        .HasColumnName("ProductModelID")
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("BikeStore.Models.Review", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.SalesOrderDetail", b =>
                {
            ...
            modelBuilder.Entity("BikeStore.Models.SalesOrderHeader", b =>
                {
                    b.Property<int>("SalesOrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("SalesOrderID")
            ...
            modelBuilder.Entity("BikeStore.Models.CustomerAddress", b =>
                {
                    b.HasOne("BikeStore.Models.Address", "Address")
            ...
            modelBuilder.Entity("BikeStore.Models.Product", b =>
                {
                    b.HasOne("BikeStore.Models.ProductCategory", "ProductCategory")
                        .WithMany("Product")
                        .HasForeignKey("ProductCategoryId");

                    b.HasOne("BikeStore.Models.ProductModel", "ProductModel")
                        .WithMany("Product")
            ...
            modelBuilder.Entity("BikeStore.Models.ProductCategory", b =>
                {
                    b.HasOne("BikeStore.Models.ProductCategory", "ParentProductCategory")
            ...
            modelBuilder.Entity("BikeStore.Models.ProductModelProductDescription", b =>
                {
                    b.HasOne("BikeStore.Models.ProductDescription", "ProductDescription")
            ...
            modelBuilder.Entity("BikeStore.Models.SalesOrderDetail", b =>
                {
                    ...
                    b.HasOne("BikeStore.Models.SalesOrderHeader", "SalesOrder")
                        .WithMany("SalesOrderDetail")
            ...
            modelBuilder.Entity("BikeStore.Models.SalesOrderHeader", b =>
                {
                    b.HasOne("BikeStore.Models.Address", "BillToAddress")
                    ...
                    b.HasOne("BikeStore.Models.Address", "ShipToAddress")
